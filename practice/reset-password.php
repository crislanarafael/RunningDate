...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($new_password_err) && empty($confirm_password_err)){
        ...
        $sql = "UPDATE users SET password = ? WHERE id = ?";  //sql query
...
<head>
    ...
    <style type="text/css">
        ...
        .wrapper{
            ...
            background: linear-gradient(rgba(0,2,0,0.2), rgba(0,0,0,0.4)), url("resetpassword.jpg") no-repeat center center/cover;
